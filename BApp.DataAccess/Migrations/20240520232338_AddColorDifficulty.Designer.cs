...
namespace BApp.DataAccess.Migrations
{
    ...
    [Migration("20240520232338_AddColorDifficulty")]
    partial class AddColorDifficulty
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BApp.Domain.Models.ColorDifficulty", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("BApp.Domain.Models.UserColor", b =>
                {
                    ...
                    b.Property<int>("ColorDifficultyId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("BApp.Domain.Models.UserColor", b =>
                {
                    b.HasOne("BApp.Domain.Models.ColorDifficulty", "ColorDifficulty")
                        .WithMany("UserColors")
                        .HasForeignKey("ColorDifficultyId")
